...
native_to_managed_trampoline_StepCounter_UnsupportedDevice__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_40));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_StepCounter_SevenDayOverview_get_lblDistance (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_StepCounter_SevenDayOverview_set_lblDistance (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_StepCounter_SevenDayOverview_get_lblWeeklyMiles (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_StepCounter_SevenDayOverview_set_lblWeeklyMiles (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_StepCounter_SevenDayOverview_DidReceiveMemoryWarning (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_StepCounter_SevenDayOverview_ViewDidLoad (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_StepCounter_HostViewController_get_scrollView (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_StepCounter_HostViewController_set_scrollView (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_StepCounter_HostViewController__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_52));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_StepCounter_HostViewController_DidReceiveMemoryWarning (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_StepCounter_HostViewController_ViewDidLoad (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
static MTClassMap __monotouch_class_map [] = {
	...
	{"SevenDayOverview", "StepCounter.SevenDayOverview, StepCounter", 0},
	{"UIWindow", "MonoTouch.UIKit.UIWindow, monotouch", 0},
	{"HostViewController", "StepCounter.HostViewController, StepCounter", 0},
...
static MTClass __monotouch_classes [] = {
	...
	{"StepCounterViewController", "UIViewController", 1, 21, 0},
	{"UnsupportedDevice", "UIViewController", 1, 8, 0},
	{"SevenDayOverview", "UIViewController", 1, 6, 0},
	{"HostViewController", "UIViewController", 1, 5, 0},
...
static MTMethod __monotouch_methods [] = {
	...
	{"lblDistance","@@:",0, &native_to_managed_trampoline_StepCounter_SevenDayOverview_get_lblDistance},
	{"setLblDistance:","v@:@",0, &native_to_managed_trampoline_StepCounter_SevenDayOverview_set_lblDistance},
	{"lblWeeklyMiles","@@:",0, &native_to_managed_trampoline_StepCounter_SevenDayOverview_get_lblWeeklyMiles},
	{"setLblWeeklyMiles:","v@:@",0, &native_to_managed_trampoline_StepCounter_SevenDayOverview_set_lblWeeklyMiles},
	{"didReceiveMemoryWarning","v@:",0, &native_to_managed_trampoline_StepCounter_SevenDayOverview_DidReceiveMemoryWarning},
	{"viewDidLoad","v@:",0, &native_to_managed_trampoline_StepCounter_SevenDayOverview_ViewDidLoad},
	{"scrollView","@@:",0, &native_to_managed_trampoline_StepCounter_HostViewController_get_scrollView},
	{"setScrollView:","v@:@",0, &native_to_managed_trampoline_StepCounter_HostViewController_set_scrollView},
	{"init","@@:",0, &native_to_managed_trampoline_StepCounter_HostViewController__ctor},
	{"didReceiveMemoryWarning","v@:",0, &native_to_managed_trampoline_StepCounter_HostViewController_DidReceiveMemoryWarning},
	{"viewDidLoad","v@:",0, &native_to_managed_trampoline_StepCounter_HostViewController_ViewDidLoad},
...
static int __monotouch_class_count = 11;
